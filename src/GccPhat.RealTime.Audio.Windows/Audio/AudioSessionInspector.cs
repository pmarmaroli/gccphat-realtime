...
public static class AudioSessionInspector
{
    ...
    /// </summary>
    public static IReadOnlyList<AudioSessionHolder> FindActiveHolders(MMDevice device)
    {
        var holders = new List<AudioSessionHolder>();
        ...
        for (int i = 0; i < sessions.Count; i++)
        {
            ...
            try
            {
                holders.Add(new AudioSessionHolder(pid, Process.GetProcessById(pid).ProcessName));
            }
