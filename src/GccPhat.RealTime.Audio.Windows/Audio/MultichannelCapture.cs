...
///
/// Some mic-array drivers install a voice-processing APO that silences the WASAPI stream outright;
/// when that happens, <c>WindowsAudioPlatform</c> restarts capture through
/// <see cref="Audio.PortAudioCapture.FromWdmKsDeviceName"/> instead, which talks straight to the
/// driver's WDM-KS interface, below that APO. See MainViewModel's silence-probe fallback.
/// </summary>
