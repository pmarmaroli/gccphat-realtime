...
{
    private static readonly string ModelFile = Path.Combine("Assets", "yamnet.onnx");
    private static readonly string ClassMapFile = Path.Combine("Assets", "yamnet_class_map.csv");
